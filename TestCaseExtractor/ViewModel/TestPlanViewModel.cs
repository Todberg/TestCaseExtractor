...
namespace TestCaseExtractor.ViewModel
{
    public class TestPlanViewModel : TreeViewItemViewModel
    {
        ...
        public string Name
        {
            get
            {
                return this._testPlan.TFSTestPlan.get_Name();
            }
        }
        public TestPlanViewModel(TestPlan testPlan, TeamProjectViewModel parentTeamProject, byte lazyLoadLevels)
            : base(parentTeamProject)
        {
